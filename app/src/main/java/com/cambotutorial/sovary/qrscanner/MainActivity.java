    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       final  Calendar calendar=Calendar.getInstance();
        ...
        receptionDate.setOnClickListener(view -> {
              DatePickerDialog datePickerDialog= new DatePickerDialog(MainActivity.this, (datePicker, year, month, date) -> receptionDate.setText(date+"-"+month+"-"+year),year,month,day);
              datePickerDialog.show();
         });

        extractionDate.setOnClickListener(view -> {
            DatePickerDialog datePickerDialog= new DatePickerDialog(MainActivity.this, (datePicker, year, month, date) -> extractionDate.setText(date+"-"+month+"-"+year),year,month,day);
            datePickerDialog.show();
        });

        datee.setOnClickListener(view -> {
            DatePickerDialog datePickerDialog= new DatePickerDialog(MainActivity.this, (datePicker, year, month, date) -> datee.setText(date+"-"+month+"-"+year),year,month,day);
            datePickerDialog.show();
        });
            ...
            public boolean handleMessage(Message msg) {
                ...
                switch (msg.what) {
                    ...
                    case STATE_MESSAGE_RECEIVED:
                        ...
                        receptionDate.setText(parts[1]);
                        extractionDate.setText(parts[2]);
                        chainid.setText(parts[3]);
                        quantity.setText(parts[4]);
                        code.setText(parts[5]);
                        datee.setText(parts[6]);
                        send.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View view) {
                                // String string= String.valueOf(name.getText());
